...
async function loadRecommendations() {
    try {
        ...
        document.getElementById('dueReviews').textContent = recommendations.due_reviews;
        document.getElementById('masteredCards').textContent = recommendations.total_cards_mastered;
